...
$(function() {
	...
	$('.e-banner-iterm-video').each(function (index, el) {
		...
		if ($.spice.getWindowWidth() > 1024) {
			...
			// 请求视频源地址
			var videoUrl = 'https://cm14-ccm1-2.play.bokecc.com/flvs/ca/QxEPQ/uO126L9uFA-30.mp4?t=1533200154&key=E2D6B862622F9B7EAD19043212F9B1FC';
	...
	//8-2 获取焦点
	var apple = document.getElementById('keyword');
